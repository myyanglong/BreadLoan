...
public class OkHttpClientManager
{
    ...
    private HttpsDelegate mHttpsDelegate = new HttpsDelegate(); //https模块
    private DownloadDelegate mDownloadDelegate = new DownloadDelegate();//下载模块
    private DisplayImageDelegate mDisplayImageDelegate = new DisplayImageDelegate();//加载图片
    private GetDelegate mGetDelegate = new GetDelegate();
    private UploadDelegate mUploadDelegate = new UploadDelegate(); //上传模块
	...
	private OkHttpClientManager()
    {
        ...
        //cookie enabled
        CookieStore cs = new MyCookieStore();
        mOkHttpClient.setCookieHandler(new CookieManager(cs, CookiePolicy.ACCEPT_ORIGINAL_SERVER));
     ...
     * ============POST方便的访问方式===============
     */
    public static void postAsyn(String url, Param[] params,String  Method, final ResultCallback callback)
    {
        getInstance().getPostDelegate().postAsyn(url, params, callback, null,Method);
    }
    ...
    private Request buildPostFormRequest(String url, Param[] params, Object tag,String Method)
    {
        if (params == null)
        {
            params = new Param[0];
    ...
    private Request buildPostFormRequest(String url, Param[] params,String userCode,long time,String key, Object tag,String Method)
    {
        if (params == null)
        {
            params = new Param[0];
    ...
    public class PostDelegate
    {
        ...
        public void postAsyn(String url, Param[] params,String userCode,long time,String key, final ResultCallback callback)
        {
            postAsyn(url, params, callback, null,"", userCode, time, key);
        }

        /**
         * 异步的post请求
         */
        public void postAsyn(String url, Param[] params, final ResultCallback callback, Object tag,String Method)
        {
            Request request = buildPostFormRequest(url, params, tag,Method);
         ...
         * 异步的post请求
         */
        public void postAsyn(String url, Param[] params, final ResultCallback callback, Object tag,String Method,String userCode,long time,String key)
        {
            Request request = buildPostFormRequest(url, params, userCode, time, key, tag,Method);
            deliveryResult(callback, request);
        }
    ...
    *
    ...
    public class GetDelegate
    {
        ...
        private Request buildGetRequest(String url, Object tag,String Handers)
        {
            Request.Builder builder = new Request.Builder()
                    .url(url)
                    .addHeader("ACCESS_TOKEN",Handers);
         ...
         * 异步的get请求
         */
        public void getAsyn(String url, final ResultCallback callback,String Handers)
        {
            getAsyn(url, callback,null,Handers);
        }

        public void getAsyn(String url, final ResultCallback callback, Object tag,String Handers)
        {
            final Request request = buildGetRequest(url, tag,Handers);
